...
export default function ModeratorDashboard() {
    ...
    // Protect route - only moderators can access
    React.useEffect(() => {
                ...
                <div className="flex items-center justify-between">
                    <div>
                        <h1 className="text-2xl font-bold">
                            RESPOND<span className="text-warning-400">.AI</span> - Moderator Dashboard
                        </h1>
                        <p className="text-sm text-gray-400">
                            Welcome, <span className="text-blue-400 font-medium">{user.name}</span> 🛡️
                        </p>
                    </div>
                    <div className="flex items-center gap-4">
                        <div className="glass rounded-lg px-4 py-2">
                            <p className="text-xs text-gray-400">Role</p>
                            <p className="font-bold text-blue-400">Moderator</p>
                        </div>
                        <button
                ...
                <div className="h-full glass rounded-2xl p-6 border-2 border-white/10">
                    <div className="flex items-center justify-between mb-4">
                        <div>
                            ...
                            <p className="text-sm text-gray-400">Click on any crisis marker to view details and manage response</p>
                        </div>
